'''Trains a CNN over the time segments of data and all patients, leaving one out
'''
...
if __name__ == "__main__":
    ...
    model.compile(loss='categorical_crossentropy',
                  optimizer='sgd')
    los = 15
    X_train, Y_train = data_generator_one_patient(main_folder=main_folder, patient_number=1, size_in=size_in, leaveout_sample=0,
                                                  isTrain=True)
